        ...
        <div className="card" style={{ padding: 24, margin: '24px auto', maxWidth: 900 }}>
          ...
          <form className="stack" onSubmit={createPlan} style={{ gap: 10, marginTop: 12 }}>
            <div className="row" style={{ gap: 12 }}>
              <input className="input" placeholder="Plan name (e.g., Starter)" value={name} onChange={function (e) { return setName(e.target.value); }}/>
              <input className="input" type="number" placeholder="Price" value={price} onChange={function (e) { return setPrice(Number(e.target.value || 0)); }} style={{ width: 140 }}/>
              <input className="input" type="number" placeholder="Match quota" value={matchQuota} onChange={function (e) { return setMatchQuota(Number(e.target.value || 0)); }} style={{ width: 140 }}/>
            </div>
            <textarea className="input" placeholder="Offers (one per line)" rows={4} value={offersText} onChange={function (e) { return setOffersText(e.target.value); }}/>
            <div className="row" style={{ gap: 12 }}>
