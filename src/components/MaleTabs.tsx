  ...
  return (
    <div className="tab-btn-row">
      ...
      <Link className={`tab-btn${is('/dashboard/random-call') ? ' tab-btn-active' : ''}`} to="/dashboard/random-call">
        <span className="tab-btn-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#34D399" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" role="img" aria-label="Random Call">
